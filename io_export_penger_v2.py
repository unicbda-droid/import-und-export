...
class EXPORT_OT_penger_v2(Operator, ExportHelper):
    bl_idname = "export_scene.penger_v2"
    bl_label = "Export Penger v2"
    bl_description = "Export active mesh as .penger (3-section)"
    filename_ext = ".penger"
...
def menu_func_export(self, context):
    self.layout.operator(EXPORT_OT_penger_v2.bl_idname, text="Penger v2 (.penger)")


def register():
    bpy.utils.register_class(EXPORT_OT_penger_v2)
    bpy.types.TOPBAR_MT_file_export.append(menu_func_export)


def unregister():
    bpy.types.TOPBAR_MT_file_export.remove(menu_func_export)
    bpy.utils.unregister_class(EXPORT_OT_penger_v2)
